...
% \frametitle{目次}
 ...
 %\hspace{40pt}
	\begin{column}{0.3\linewidth}
	 \includemovie[autoplay, label=headorigin]{40mm}{40mm}{movies/obstacle_origin.mp4}
	\end{column}
	\begin{column}{0.3\linewidth}
	\includemovie[autoplay, label=headdev2]{40mm}{40mm}{movies/obstacle_dev2.mp4}
    \end{column}
...
\begin{columns}[T]
	...
	\begin{block}{計算機実験}
	\begin{itemize}
%	\item CPU:Apple M4 Pro，メモリ:64GB
...
\includemovie[autoplay, label=origin]{40mm}{40mm}{movies/obstacle_origin.mp4}
    \end{column}
    \begin{column}{0.33\textwidth}
\includemovie[autoplay, label=dev1]{40mm}{40mm}{movies/obstacle_dev1_color.mp4}
    \end{column}
    \begin{column}{0.33\textwidth}
\includemovie[autoplay, label=dev2]{40mm}{40mm}{movies/obstacle_dev2_color.mp4}
    \end{column}
\end{columns}
\end{frame}
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
